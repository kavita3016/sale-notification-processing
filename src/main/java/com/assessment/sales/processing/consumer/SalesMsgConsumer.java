...
import com.assessment.sales.processing.service.impl.SalesNotificationProcessServiceImpl;
...
public class SalesMsgConsumer {
    ...
    @Autowired
    private SalesNotificationProcessServiceImpl salesNotificationService;
